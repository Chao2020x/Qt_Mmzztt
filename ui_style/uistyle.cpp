...
QString UIStyle::setPushButtonQss(QPushButton *btn, int radius, int padding,
...
QString UIStyle::setLineEditQss(QLineEdit *txt, int radius, int borderWidth,
                                  const QString &normalColor,
...
QString UIStyle::setSpinBoxQss(QSpinBox *sbox, int radius, int borderWidth,
                               const QString &normalColor, const QString &focusColor)
{
    QStringList list;
    list.append(QString("QSpinBox{border-style:none;padding:0px;border-radius:%1px;border:%2px solid %3;}")
                .arg(radius).arg(borderWidth).arg(normalColor));
    list.append(QString("QSpinBox:focus{border:%1px solid %2;}")
                .arg(borderWidth).arg(focusColor));

    QString qss = list.join("");
    sbox->setStyleSheet(qss);
    return qss;
}

QString UIStyle::setDoubleSpinBoxQss(QDoubleSpinBox *dsbox, int radius, int borderWidth,
                                     const QString &normalColor, const QString &focusColor)
{
    QStringList list;
    list.append(QString("QDoubleSpinBox{border-style:none;padding:0px;border-radius:%1px;border:%2px solid %3;}")
                .arg(radius).arg(borderWidth).arg(normalColor));
    list.append(QString("QDoubleSpinBox:focus{border:%1px solid %2;}")
                .arg(borderWidth).arg(focusColor));

    QString qss = list.join("");
    dsbox->setStyleSheet(qss);
    return qss;
}

QString UIStyle::setProgressQss(QProgressBar *bar, int barHeight,
...
QString UIStyle::setSliderQss(QSlider *slider, int sliderHeight,
                                const QString &normalColor,
...
QString UIStyle::setRadioButtonQss(QRadioButton *rbtn, int indicatorRadius,
                                     const QString &normalColor,
...
QString UIStyle::setScrollBarQss(QWidget *scroll, int radius, int min, int max,
...
QString UIStyle::setDateEditQss(QWidget *dateEdit, int radius, int padding, const QString &normalColor, const QString &normalTextColor, const QString &hoverColor, const QString &hoverTextColor, const QString &pressedColor, const QString &pressedTextColor)
{
    QStringList list;
    list.append(QString("QPushButton{border-style:none;padding:%1px;border-radius:%2px;color:%3;background:%4;}")
                .arg(padding).arg(radius).arg(normalTextColor).arg(normalColor));
