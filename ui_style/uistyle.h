...
public:
    ...
    //设置SpinBox框样式
    static QString setSpinBoxQss(QSpinBox *sbox,                                   //文本框对象
                                  int radius = 5,                                   //圆角半径
                                  int borderWidth = 1,                              //边框大小
                                  const QString &normalColor = "#000000",           //正常颜色
                                  const QString &focusColor = "#5DACE4");           //选中颜色

    //设置QDoubleSpinBox框样式
    static QString setDoubleSpinBoxQss(QDoubleSpinBox *dsbox,                                   //文本框对象
                                  int radius = 5,                                   //圆角半径
                                  int borderWidth = 1,                              //边框大小
                                  const QString &normalColor = "#000000",           //正常颜色
                                  const QString &focusColor = "#5DACE4");           //选中颜色
    ...
    static QString setDateEditQss(QWidget *dateEdit,                              //对象
                                  int radius = 5,                                 //圆角半径
                                  int padding = 8,                                //间距
                                  const QString &normalColor = "#34495E",         //正常颜色
                                  const QString &normalTextColor = "#FFFFFF",     //文字颜色
